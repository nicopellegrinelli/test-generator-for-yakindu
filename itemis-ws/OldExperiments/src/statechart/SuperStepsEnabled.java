...
public class SuperStepsEnabled implements IEventDriven {
	public enum State {
		MAIN_REGION_A,
		MAIN_REGION_B,
		MAIN_REGION_C,
	...
	public SuperStepsEnabled() {
		...
		/* Default init sequence for statechart SuperStepsEnabled */
		setX(0l);
	...
	public void enter() {
		...
		isExecuting = true;
		/* Default enter sequence for statechart SuperStepsEnabled */
	...
	public void exit() {
		...
		isExecuting = true;
		/* Default exit sequence for statechart SuperStepsEnabled */
