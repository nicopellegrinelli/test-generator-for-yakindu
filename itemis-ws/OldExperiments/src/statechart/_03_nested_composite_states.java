...
public class _03_nested_composite_states implements ITimed, ICycleBased {
	...
	private static class TimeEventsEvBuf {
		private boolean _03_nested_composite_states_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0;
	}
	private static class _03_nested_composite_statesEvBuf {
	...
	private _03_nested_composite_statesEvBuf current = new _03_nested_composite_statesEvBuf();
	...
	public _03_nested_composite_states() {
		user = new User();
		sensor = new Sensor();
		...
		/* Default init sequence for statechart _03_nested_composite_states */
		setBrightness(0l);
	...
	public void enter() {
		...
		isExecuting = true;
		/* Default enter sequence for statechart _03_nested_composite_states */
	...
	public void exit() {
		...
		isExecuting = true;
		/* Default exit sequence for statechart _03_nested_composite_states */
	...
	*/
	...
	private void swapInEvents() {
		...
		current.timeEvents._03_nested_composite_states_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0 = timeEvents[0];
		timeEvents[0] = false;
	}
	...
	*/
	...
	private long main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_react(long transitioned_before) {
		...
		long transitioned_after = transitioned_before;
		if (transitioned_after<0l) {
			if (current.timeEvents._03_nested_composite_states_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0) {
				exitSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected();
				current.timeEvents._03_nested_composite_states_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0 = false;
				enterSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1_Idle_default();
				main_region_AutomaticMode_r1_MotionDetectionMode_react(0l);
				transitioned_after = 0l;
			} else {
