...
public class _02_shallow_history implements ITimed, ICycleBased {
	...
	private static class TimeEventsEvBuf {
		private boolean _02_shallow_history_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0;
	}
	private static class _02_shallow_historyEvBuf {
	...
	private _02_shallow_historyEvBuf current = new _02_shallow_historyEvBuf();
	...
	public _02_shallow_history() {
		...
		/* Default init sequence for statechart _02_shallow_history */
		setBrightness(0l);
	...
	public void enter() {
		...
		isExecuting = true;
		/* Default enter sequence for statechart _02_shallow_history */
	...
	public void exit() {
		...
		isExecuting = true;
		/* Default exit sequence for statechart _02_shallow_history */
	...
	*/
	...
	private void swapInEvents() {
		...
		current.timeEvents._02_shallow_history_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0 = timeEvents[0];
		timeEvents[0] = false;
	}
	...
	*/
	...
	private void shallowEnterSequence_main_region_AutomaticMode_r1() {
		/* shallow enterSequence with history in child r1 */
	...
	private void react_main_region_AutomaticMode_r1__entry_Default() {
		...
		if (historyVector[0] != State.$NULLSTATE$) {
			shallowEnterSequence_main_region_AutomaticMode_r1();
		} else {
			enterSequence_main_region_AutomaticMode_r1_MotionDetectionMode_default();
		}
	}
	...
	private long main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_react(long transitioned_before) {
		...
		long transitioned_after = transitioned_before;
		if (transitioned_after<0l) {
			if (current.timeEvents._02_shallow_history_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0) {
				exitSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected();
				current.timeEvents._02_shallow_history_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0 = false;
				enterSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1_Idle_default();
				main_region_AutomaticMode_r1_MotionDetectionMode_react(0l);
				transitioned_after = 0l;
			} else {
