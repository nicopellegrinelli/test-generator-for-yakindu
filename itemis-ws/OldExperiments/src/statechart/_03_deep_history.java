...
public class _03_deep_history implements ITimed, ICycleBased {
	...
	private static class TimeEventsEvBuf {
		private boolean _03_deep_history_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0;
	}
	private static class _03_deep_historyEvBuf {
	...
	private _03_deep_historyEvBuf current = new _03_deep_historyEvBuf();
	...
	public _03_deep_history() {
		...
		/* Default init sequence for statechart _03_deep_history */
		setBrightness(0l);
	...
	public void enter() {
		...
		isExecuting = true;
		/* Default enter sequence for statechart _03_deep_history */
	...
	public void exit() {
		...
		isExecuting = true;
		/* Default exit sequence for statechart _03_deep_history */
	...
	*/
	...
	private void swapInEvents() {
		...
		current.timeEvents._03_deep_history_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0 = timeEvents[0];
		timeEvents[0] = false;
	}
	...
	*/
	...
	private void deepEnterSequence_main_region_AutomaticMode_r1() {
		/* deep enterSequence with history in child r1 */
		switch (historyVector[0]) {
		case MAIN_REGION_AUTOMATICMODE_R1_TWILIGHTDETECTIONMODE_R1_IDLE:
			/* enterSequence with history in child TwilightDetectionMode for leaf Idle */
			deepEnterSequence_main_region_AutomaticMode_r1_TwilightDetectionMode_r1();
			break;
		case MAIN_REGION_AUTOMATICMODE_R1_TWILIGHTDETECTIONMODE_R1_TWILIGHTDETECTED:
			/* enterSequence with history in child TwilightDetectionMode for leaf TwilightDetected */
			deepEnterSequence_main_region_AutomaticMode_r1_TwilightDetectionMode_r1();
			break;
		case MAIN_REGION_AUTOMATICMODE_R1_MOTIONDETECTIONMODE_R1_IDLE:
			/* enterSequence with history in child MotionDetectionMode for leaf Idle */
			deepEnterSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1();
			break;
		case MAIN_REGION_AUTOMATICMODE_R1_MOTIONDETECTIONMODE_R1_MOTIONDETECTED:
			/* enterSequence with history in child MotionDetectionMode for leaf MotionDetected */
			deepEnterSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1();
			break;
		default:
			break;
	...
	/* deep enterSequence with history in child r1 */
	private void deepEnterSequence_main_region_AutomaticMode_r1_TwilightDetectionMode_r1() {
		/* deep enterSequence with history in child r1 */
		...
		case MAIN_REGION_AUTOMATICMODE_R1_TWILIGHTDETECTIONMODE_R1_IDLE:
			...
			break;
		case MAIN_REGION_AUTOMATICMODE_R1_TWILIGHTDETECTIONMODE_R1_TWILIGHTDETECTED:
			/* enterSequence with history in child TwilightDetected for leaf TwilightDetected */
	...
	/* deep enterSequence with history in child r1 */
	private void deepEnterSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1() {
		/* deep enterSequence with history in child r1 */
		...
		case MAIN_REGION_AUTOMATICMODE_R1_MOTIONDETECTIONMODE_R1_IDLE:
			...
			break;
		case MAIN_REGION_AUTOMATICMODE_R1_MOTIONDETECTIONMODE_R1_MOTIONDETECTED:
			/* enterSequence with history in child MotionDetected for leaf MotionDetected */
	...
	private long main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_react(long transitioned_before) {
		...
		long transitioned_after = transitioned_before;
		if (transitioned_after<0l) {
			if (current.timeEvents._03_deep_history_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0) {
				exitSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected();
				current.timeEvents._03_deep_history_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0 = false;
				enterSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1_Idle_default();
				main_region_AutomaticMode_r1_MotionDetectionMode_react(0l);
				transitioned_after = 0l;
			} else {
