...
public class OperationTestSimplified implements IEventDriven {

    public static class I {

        private OperationTestSimplified parent;

        public I(OperationTestSimplified parent) {
            this.parent = parent;
        }
    ...
    public OperationTestSimplified() {
        i = new I(this);
        for (int i = 0; i < 1; i++) {
            stateVector[i] = State.$NULLSTATE$;
        }
        clearInEvents();
        /* Default init sequence for statechart OperationTest */
        setVal(0l);
        isExecuting = false;
    }
    ...
    public void enter() {
        ...
        if (this.i.operationCallback == null) {
            throw new IllegalStateException("Operation callback for interface I must be set.");
        }
        ...
        isExecuting = true;
        /* Default enter sequence for statechart OperationTest */
    ...
    public void exit() {
        ...
        isExecuting = true;
        /* Default exit sequence for statechart OperationTest */
