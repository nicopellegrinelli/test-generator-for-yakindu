...
public class TrafficLight_WTSimplified implements ITimed, IEventDriven {

    public enum State {

        MAIN_REGION_RED, MAIN_REGION_YELLOW, MAIN_REGION_GREEN, MAIN_REGION_GREEN_AFTER60S, $NULLSTATE$
    }
    ...
    public TrafficLight_WTSimplified() {
        for (int i = 0; i < 1; i++) {
