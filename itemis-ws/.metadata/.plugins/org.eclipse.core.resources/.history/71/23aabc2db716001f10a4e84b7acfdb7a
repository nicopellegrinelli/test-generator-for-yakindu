...
public class __ReleaseProcess implements ITimed, ICycleBased {
	...
	*/
	...
	private void exitSequence_process_Released() {
		/* Default exit sequence for state Released */
		stateVector[0] = State.$NULLSTATE$;
	}
	...
	private long process__final__react(long transitioned_before) {
