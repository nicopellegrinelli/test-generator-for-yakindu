...
public class ConfigureSimplified implements ITimed, IEventDriven {
    ...
    private long getWritten() {
        return written;
    }

    private void setWritten(long value) {
        this.written = value;
    }
    ...
    static final private long timeout = 1000l;

    private long getTimeout() {
        return timeout;
    }

    static final private long writetime = 50l;

    private long getWritetime() {
        return writetime;
    }

    static final private long flashtime = 200l;

    private long getFlashtime() {
        return flashtime;
    }

    static final private long resettime = 3500l;
    ...
    private void setIdx(long value) {
        this.idx = value;
    }
