...
public class Sensor_ComponentSimplified implements ITimed, IEventDriven {

    public enum State {

        _SENSOR_COMPONENT___SENSOR_MONITORING_, _SENSOR_COMPONENT___SENSOR_MONITORING___SENSING__UNDER_THRESHOLD, _SENSOR_COMPONENT___SENSOR_MONITORING___SENSING__THRESHOLD_REACHED, _SENSOR_COMPONENT___OFF_, $NULLSTATE$
    }
    ...
    public Sensor_ComponentSimplified() {
        for (int i = 0; i < 1; i++) {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case _SENSOR_COMPONENT___SENSOR_MONITORING_:
                return stateVector[0].ordinal() >= State._SENSOR_COMPONENT___SENSOR_MONITORING_.ordinal() && stateVector[0].ordinal() <= State._SENSOR_COMPONENT___SENSOR_MONITORING___SENSING__THRESHOLD_REACHED.ordinal();
            case _SENSOR_COMPONENT___SENSOR_MONITORING___SENSING__UNDER_THRESHOLD:
