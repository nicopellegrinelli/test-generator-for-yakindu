...
public class MqttClientStatechartSimplified implements ITimed, ICycleBased {
    ...
    public static class System {
        ...
        private Observable<Void> getReset() {
    ...
    public static class WizFi360 {
        ...
        private void raiseSetStationMode() {
            setStationMode = true;
        ...
        private Observable<Void> getSetStationMode() {
            return setStationModeObservable;
        }

        private boolean enableDhcp;

        private void raiseEnableDhcp() {
            enableDhcp = true;
        ...
        private Observable<Void> getEnableDhcp() {
            return enableDhcpObservable;
        }

        private boolean connectToAccessPoint;

        private void raiseConnectToAccessPoint() {
        ...
        private Observable<Void> getConnectToAccessPoint() {
            return connectToAccessPointObservable;
        }

        private boolean configureMqtt;

        private void raiseConfigureMqtt() {
            configureMqtt = true;
        ...
        private Observable<Void> getConfigureMqtt() {
            return configureMqttObservable;
        }

        private boolean setTopic;

        private void raiseSetTopic() {
            setTopic = true;
        ...
        private Observable<Void> getSetTopic() {
            return setTopicObservable;
        }

        private boolean connectToBroker;

        private void raiseConnectToBroker() {
        ...
        private Observable<Void> getConnectToBroker() {
            return connectToBrokerObservable;
        }

        private boolean publishTopic;

        private void raisePublishTopic() {
            publishTopic = true;
        ...
        private Observable<Void> getPublishTopic() {
            return publishTopicObservable;
        }

        private boolean testModule;

        private void raiseTestModule() {
            testModule = true;
        ...
        private Observable<Void> getTestModule() {
            return testModuleObservable;
        }

        private boolean restartModule;

        private void raiseRestartModule() {
            restartModule = true;
        ...
        private Observable<Void> getRestartModule() {
            return restartModuleObservable;
        }

        private boolean ledOn;

        private void raiseLedOn() {
            ledOn = true;
        ...
        private Observable<Void> getLedOn() {
            return ledOnObservable;
        }

        private boolean resetModule;

        private void raiseResetModule() {
            resetModule = true;
        ...
        private Observable<Void> getResetModule() {
        ...
        private Observable<Void> getStart() {
        ...
        private Observable<Void> getStop() {
        ...
        private void setWifiConnected(boolean value) {
            this.wifiConnected = value;
        }

        private long wifiFailCounter;

        private long getWifiFailCounter() {
            return wifiFailCounter;
        }

        private void setWifiFailCounter(long value) {
            this.wifiFailCounter = value;
        }

        private long testFailCounter;

        private long getTestFailCounter() {
            return testFailCounter;
        }

        private void setTestFailCounter(long value) {
            this.testFailCounter = value;
        }

        private long restartFailCounter;

        private long getRestartFailCounter() {
            return restartFailCounter;
        }

        private void setRestartFailCounter(long value) {
            this.restartFailCounter = value;
        }

        private long resetFailCounter;

        private long getResetFailCounter() {
            return resetFailCounter;
        }

        private void setResetFailCounter(long value) {
        ...
        private void setLedState(boolean value) {
            this.ledState = value;
        }
    }
    ...
    public MqttClientStatechartSimplified() {
        system = new System();
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case MAIN_REGION_UNDEFINED:
                return stateVector[0].ordinal() >= State.MAIN_REGION_UNDEFINED.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_UNDEFINED_R1_STOP.ordinal();
            case MAIN_REGION_UNDEFINED_R1_ENTRY:
            ...
            case MAIN_REGION_ONLINE:
                return stateVector[0].ordinal() >= State.MAIN_REGION_ONLINE.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_ONLINE_R1_RECEIVEMESSAGES.ordinal();
            case MAIN_REGION_ONLINE_R1_ENTRY:
                return stateVector[0] == State.MAIN_REGION_ONLINE_R1_ENTRY;
            case MAIN_REGION_ONLINE_R1_PUBLISHMESSAGES:
                return stateVector[0].ordinal() >= State.MAIN_REGION_ONLINE_R1_PUBLISHMESSAGES.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_ONLINE_R1_PUBLISHMESSAGES_R1_WAIT.ordinal();
            case MAIN_REGION_ONLINE_R1_PUBLISHMESSAGES_R1_PUBLISHTOPIC:
            ...
            case MAIN_REGION_OFFLINE:
                return stateVector[0].ordinal() >= State.MAIN_REGION_OFFLINE.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_OFFLINE_R1_CONNECTTOACCESSPOINT.ordinal();
            case MAIN_REGION_OFFLINE_R1_SETTOPIC:
    ...
    private long getPublishInterval() {
        return publishInterval;
    }

    private void setPublishInterval(long value) {
        this.publishInterval = value;
    }

    private boolean publishingEnabled;

    private boolean getPublishingEnabled() {
        return publishingEnabled;
    }

    private void setPublishingEnabled(boolean value) {
        this.publishingEnabled = value;
    }

    private long watchdogTimer;

    private long getWatchdogTimer() {
        return watchdogTimer;
    }

    private void setWatchdogTimer(long value) {
