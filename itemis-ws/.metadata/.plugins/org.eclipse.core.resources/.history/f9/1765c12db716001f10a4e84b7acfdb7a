...
public class _01_No_History implements ITimed, ICycleBased {
	...
	private static class TimeEventsEvBuf {
		private boolean _01_No_History_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0;
	}
	private static class _01_No_HistoryEvBuf {
	...
	private _01_No_HistoryEvBuf current = new _01_No_HistoryEvBuf();
	...
	public _01_No_History() {
		...
		/* Default init sequence for statechart _01_No_History */
		setBrightness(0l);
	...
	public void enter() {
		...
		isExecuting = true;
		/* Default enter sequence for statechart _01_No_History */
	...
	public void exit() {
		...
		isExecuting = true;
		/* Default exit sequence for statechart _01_No_History */
	...
	*/
	...
	private void swapInEvents() {
		...
		current.timeEvents._01_No_History_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0 = timeEvents[0];
		timeEvents[0] = false;
	}
	...
	*/
	...
	private long main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_react(long transitioned_before) {
		...
		long transitioned_after = transitioned_before;
		if (transitioned_after<0l) {
			if (current.timeEvents._01_No_History_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0) {
				exitSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected();
				current.timeEvents._01_No_History_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0 = false;
				enterSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1_Idle_default();
				main_region_AutomaticMode_r1_MotionDetectionMode_react(0l);
				transitioned_after = 0l;
			} else {
