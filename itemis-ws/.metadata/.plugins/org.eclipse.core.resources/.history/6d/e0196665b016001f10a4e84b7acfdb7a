...
public class _01_LightSwitch implements IEventDriven {
	public enum State {
		MAIN_OFF,
		MAIN_ON,
		$NULLSTATE$
	...
	public void enter() {
		...
		isExecuting = true;
		/* Default enter sequence for statechart _01_LightSwitch */
	...
	public void exit() {
		...
		isExecuting = true;
		/* Default exit sequence for statechart _01_LightSwitch */
		exitSequence_main();
		isExecuting = false;
	}
