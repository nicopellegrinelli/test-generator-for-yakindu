...
public class _TrolleySimplified implements ITimed, IEventDriven {
    ...
    private boolean getIsDoorObstructed() {
        return isDoorObstructed;
    }

    private void setIsDoorObstructed(boolean value) {
        this.isDoorObstructed = value;
    }

    private boolean isDoorAvailable;

    private boolean getIsDoorAvailable() {
        return isDoorAvailable;
    }

    private void setIsDoorAvailable(boolean value) {
        this.isDoorAvailable = value;
    }

    private boolean isEmergencyActive;

    private boolean getIsEmergencyActive() {
        return isEmergencyActive;
    }

    private void setIsEmergencyActive(boolean value) {
        this.isEmergencyActive = value;
    }

    private boolean wasDepartureState;

    private boolean getWasDepartureState() {
        return wasDepartureState;
    }

    private void setWasDepartureState(boolean value) {
        this.wasDepartureState = value;
    }

    private long currentStation;

    private long getCurrentStation() {
        return currentStation;
    }

    private void setCurrentStation(long value) {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case MAIN_REGION_TROLLEY:
                return stateVector[0].ordinal() >= State.MAIN_REGION_TROLLEY.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_TROLLEY_REQUESTHANDLER_ACCEPTINGREQUESTS.ordinal();
            case MAIN_REGION_TROLLEY_BOARDINGMANAGER_DOORSCLOSED:
            ...
            case MAIN_REGION_TROLLEY_BOARDINGMANAGER_DOORSOPEN:
                return stateVector[0].ordinal() >= State.MAIN_REGION_TROLLEY_BOARDINGMANAGER_DOORSOPEN.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_TROLLEY_BOARDINGMANAGER_DOORSOPEN_R1_DOORSOBSTRUCTED.ordinal();
            case MAIN_REGION_TROLLEY_BOARDINGMANAGER_DOORSOPEN_R1_BOARDINGPOSSIBLE:
            ...
            case MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_ARRIVAL_AT_A_STATION:
                return stateVector[1].ordinal() >= State.MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_ARRIVAL_AT_A_STATION.ordinal() && stateVector[1].ordinal() <= State.MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_ARRIVAL_AT_A_STATION_R1_DOORSOPENAWAITINGREQUEST.ordinal();
            case MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_ARRIVAL_AT_A_STATION_R1_JUST_ARRIVED:
            ...
            case MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_DEPARTURE_TO_A_STATION:
                return stateVector[1].ordinal() >= State.MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_DEPARTURE_TO_A_STATION.ordinal() && stateVector[1].ordinal() <= State.MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_DEPARTURE_TO_A_STATION_R1_STARTDEPARTURE.ordinal();
            case MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_DEPARTURE_TO_A_STATION_R1_CLOSINGDOORS:
                return stateVector[1].ordinal() >= State.MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_DEPARTURE_TO_A_STATION_R1_CLOSINGDOORS.ordinal() && stateVector[1].ordinal() <= State.MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_DEPARTURE_TO_A_STATION_R1_CLOSINGDOORS_R1_DOORSOBSTRUCTED.ordinal();
            case MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_DEPARTURE_TO_A_STATION_R1_CLOSINGDOORS_R1_DOORSFREE:
            ...
            case MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_EMERGENCYSTOP:
                return stateVector[1].ordinal() >= State.MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_EMERGENCYSTOP.ordinal() && stateVector[1].ordinal() <= State.MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_EMERGENCYSTOP_R1_DOORSOPENARRIVAL.ordinal();
            case MAIN_REGION_TROLLEY_DEPARTURE_ARRIVAL_EMERGENCYSTOP_R1_EMERGENCYSTARTED:
    ...
    private void raiseDoorFree() {
        internalEventQueue.add(() -> {
            doorFree = true;
        });
    }

    private void raiseDoorObstructed() {
        internalEventQueue.add(() -> {
            doorObstructed = true;
        });
    }

    private void raiseStopAdded() {
        internalEventQueue.add(() -> {
            stopAdded = true;
        });
    }

    private void raiseOpenDoorsIn() {
        internalEventQueue.add(() -> {
            openDoorsIn = true;
        });
    }

    private void raiseCloseDoorsIn() {
        internalEventQueue.add(() -> {
            closeDoorsIn = true;
        });
    }

    private void raiseLocal_closeDoors() {
        internalEventQueue.add(() -> {
    ...
    private long getApproachingStationValue() {
    ...
    private Observable<Void> getOpenDoors() {
        return openDoorsObservable;
    }

    private boolean closeDoors;

    private void raiseCloseDoors() {
        closeDoors = true;
    ...
    private Observable<Void> getCloseDoors() {
        return closeDoorsObservable;
    }

    private boolean startDoorsSignal;

    private void raiseStartDoorsSignal() {
    ...
    private Observable<Void> getStartDoorsSignal() {
        return startDoorsSignalObservable;
    }

    private boolean stopDoorsSignal;

    private void raiseStopDoorsSignal() {
    ...
    private Observable<Void> getStopDoorsSignal() {
    ...
    private long getRequestStopValue() {
        if (!requestStop)
    ...
    private void raiseSetTargetSpeed(double value) {
    ...
    private Observable<Double> getSetTargetSpeed() {
    ...
    private Observable<Void> getRefreshUI() {
        return refreshUIObservable;
    }

    private long stopsAt;

    private long getStopsAt() {
        return stopsAt;
    }

    private void setStopsAt(long value) {
        this.stopsAt = value;
    }
    ...
    private void setRemainingCapacity(long value) {
        this.remainingCapacity = value;
    }

    private long numPassengers;

    private long getNumPassengers() {
        return numPassengers;
    }

    private void setNumPassengers(long value) {
