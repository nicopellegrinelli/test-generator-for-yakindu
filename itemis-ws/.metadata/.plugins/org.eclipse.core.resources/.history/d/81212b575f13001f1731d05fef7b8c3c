...
public class Statechart12Simplified implements ITimed, IEventDriven {
    ...
    private boolean getIsSmartMode() {
        return isSmartMode;
    }

    private void setIsSmartMode(boolean value) {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case MAIN_REGION_TRAFFICLIGHT:
                return stateVector[0].ordinal() >= State.MAIN_REGION_TRAFFICLIGHT.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_TRAFFICLIGHT_TOGGLEBUTTONHANDLING_PRESSEDLONG.ordinal();
            case MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_POLICEINTERRUPTBEHAVIOR:
                return stateVector[0].ordinal() >= State.MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_POLICEINTERRUPTBEHAVIOR.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_POLICEINTERRUPTBEHAVIOR_R1_YELLOWOFF.ordinal();
            case MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_POLICEINTERRUPTBEHAVIOR_R1_YELLOWON:
            ...
            case MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_NORMALBEHAVIOR:
                return stateVector[0].ordinal() >= State.MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_NORMALBEHAVIOR.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_NORMALBEHAVIOR_R1_YELLOW.ordinal();
            case MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_NORMALBEHAVIOR_R1_RED:
            ...
            case MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_NORMALBEHAVIOR_R1_GREEN:
                return stateVector[0].ordinal() >= State.MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_NORMALBEHAVIOR_R1_GREEN.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_NORMALBEHAVIOR_R1_GREEN_EXITLOGIC_EXITTIMERRESETTER.ordinal();
            case MAIN_REGION_TRAFFICLIGHT_TRAFFICLIGHTSHANDLING_NORMALBEHAVIOR_R1_GREEN_EXITLOGIC_EXITTIMERRESETTER:
