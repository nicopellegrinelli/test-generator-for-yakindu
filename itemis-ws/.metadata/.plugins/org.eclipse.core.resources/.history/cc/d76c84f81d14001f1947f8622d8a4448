...
public class Test_remove_duplicate_transitions implements IEventDriven {
	public static class User {
		private Test_remove_duplicate_transitions parent;
		
		public User(Test_remove_duplicate_transitions parent) {
			this.parent = parent;
		}
	...
	public Test_remove_duplicate_transitions() {
		user = new User(this);
		for (int i = 0; i < 1; i++) {
