...
public class Test_remove_duplicate_transitionsSimplified implements IEventDriven {

    public static class User {

        private Test_remove_duplicate_transitionsSimplified parent;

        public User(Test_remove_duplicate_transitionsSimplified parent) {
            this.parent = parent;
        }
    ...
    public Test_remove_duplicate_transitionsSimplified() {
        user = new User(this);
        for (int i = 0; i < 1; i++) {
    ...
    public void enter() {
        ...
        isExecuting = true;
        /* Default enter sequence for statechart test_remove_duplicate_transitions */
    ...
    public void exit() {
        ...
        isExecuting = true;
        /* Default exit sequence for statechart test_remove_duplicate_transitions */
