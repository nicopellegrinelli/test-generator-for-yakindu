...
public class Power_ComponentSimplified implements ITimed, IEventDriven {
    ...
    public enum State {
        ...
        _POWER_COMPONENT__POWER_COMPONENT, _POWER_COMPONENT__POWER_COMPONENT__CALCULATING_POWER_CONSUMPTION___NOPOWERCONSUMED_, _POWER_COMPONENT__POWER_COMPONENT__CALCULATING_POWER_CONSUMPTION___CONSUMING_POWER_, $NULLSTATE$
    }
    ...
    public Power_ComponentSimplified() {
        device = new Device();
        for (int i = 0; i < 1; i++) {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case _POWER_COMPONENT__POWER_COMPONENT:
                return stateVector[0].ordinal() >= State._POWER_COMPONENT__POWER_COMPONENT.ordinal() && stateVector[0].ordinal() <= State._POWER_COMPONENT__POWER_COMPONENT__CALCULATING_POWER_CONSUMPTION___CONSUMING_POWER_.ordinal();
            case _POWER_COMPONENT__POWER_COMPONENT__CALCULATING_POWER_CONSUMPTION___NOPOWERCONSUMED_:
    ...
    private long getKilowatt() {
        return kilowatt;
    }

    private void setKilowatt(long value) {
        this.kilowatt = value;
    }
    ...
    private void setHour(long value) {
        this.hour = value;
    }
    ...
    private void setTotalPower(long value) {
        this.totalPower = value;
    }

    private long totalHour;

    private long getTotalHour() {
        return totalHour;
    }

    private void setTotalHour(long value) {
