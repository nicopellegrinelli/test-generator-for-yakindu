...
public class Statechart7Simplified implements ITimed, IEventDriven {
    ...
    public static class Valve {
        ...
        private Observable<Void> getOPEN() {
        ...
        private Observable<Void> getCLOSE() {
    ...
    public static class ButtonMotor {
        ...
        private Statechart7Simplified parent;

        public ButtonMotor(Statechart7Simplified parent) {
            this.parent = parent;
        }
    ...
    public static class ButtonValve {
        ...
        public ButtonValve(Statechart7Simplified parent) {
            this.parent = parent;
        }
    ...
    public static class ButtonCancel {
        ...
        public ButtonCancel(Statechart7Simplified parent) {
            this.parent = parent;
        }
    ...
    private ButtonMotor buttonMotor;

    private ButtonValve buttonValve;
    ...
    private long getActivate() {
        return activate;
    }

    private void setActivate(long value) {
        this.activate = value;
    }
