...
public class TrafficLight_UnitSimplified implements ITimed, IEventDriven {

    public static class Device {

        private boolean crossingButton_triggered;

        private boolean getCrossingButton_triggered() {
            return crossingButton_triggered;
        }

        private void setCrossingButton_triggered(boolean value) {
    ...
    public static class Light {
        ...
        private TrafficLight_UnitSimplified parent;

        public Light(TrafficLight_UnitSimplified parent) {
            this.parent = parent;
        }

        private boolean red;

        private void raiseRed() {
            red = true;
        ...
        private Observable<Void> getRed() {
            return redObservable;
        }

        private boolean yellow;

        private void raiseYellow() {
            yellow = true;
        ...
        private Observable<Void> getYellow() {
            return yellowObservable;
        }

        private boolean green;

        private void raiseGreen() {
            green = true;
        ...
        private Observable<Void> getGreen() {
        ...
        private String getPedestrian() {
            return pedestrian;
        }

        private void setPedestrian(String value) {
    ...
    public static class Timer {
        ...
        public Timer(TrafficLight_UnitSimplified parent) {
            this.parent = parent;
        }
        ...
        private long getGreen_period() {
            return green_period;
        }

        private void setGreen_period(long value) {
            this.green_period = value;
        }

        private long red_period;

        private long getRed_period() {
            return red_period;
        }

        private void setRed_period(long value) {
    ...
    public TrafficLight_UnitSimplified() {
        device = new Device();
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            ...
            case _TRAFFICLIGHT_UNIT__ON:
                return stateVector[0].ordinal() >= State._TRAFFICLIGHT_UNIT__ON.ordinal() && stateVector[0].ordinal() <= State._TRAFFICLIGHT_UNIT__ON_TIMER__TIMER_RUNNING___TIMER_COUNTDOWN___FINAL_.ordinal();
            case _TRAFFICLIGHT_UNIT__ON_TRAFFICLIGHT_COLOR_GREEN:
            ...
            case _TRAFFICLIGHT_UNIT__ON_TIMER__TIMER_RUNNING_:
                return stateVector[2].ordinal() >= State._TRAFFICLIGHT_UNIT__ON_TIMER__TIMER_RUNNING_.ordinal() && stateVector[2].ordinal() <= State._TRAFFICLIGHT_UNIT__ON_TIMER__TIMER_RUNNING___TIMER_COUNTDOWN___FINAL_.ordinal();
            case _TRAFFICLIGHT_UNIT__ON_TIMER__TIMER_RUNNING___TIMER_COUNTDOWN___GREEN_PERIOD_:
    ...
    private void raiseLocal_Light_yellow() {
        internalEventQueue.add(() -> {
            local_Light_yellow = true;
        });
    }

    private void raiseLocal_Light_green() {
        internalEventQueue.add(() -> {
            local_Light_green = true;
        });
    }

    private void raiseLocal_Light_red() {
        internalEventQueue.add(() -> {
            local_Light_red = true;
        });
    }

    private void raiseLocal_Timer_reset() {
        internalEventQueue.add(() -> {
