...
public class Test_converter_entry_exit_actions implements ITimed, IEventDriven {
	public static class User {
		private Test_converter_entry_exit_actions parent;
		
		public User(Test_converter_entry_exit_actions parent) {
			this.parent = parent;
		}
	...
	public static class Sensor {
		...
		public Sensor(Test_converter_entry_exit_actions parent) {
			this.parent = parent;
		}
	...
	public Test_converter_entry_exit_actions() {
		user = new User(this);
