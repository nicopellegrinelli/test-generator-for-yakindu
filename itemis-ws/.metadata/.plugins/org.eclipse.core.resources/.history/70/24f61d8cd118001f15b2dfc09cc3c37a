...
public class Controller_ComponentSimplified implements ITimed, IEventDriven {
    ...
    public static class Actuator {
        ...
        private Controller_ComponentSimplified parent;

        public Actuator(Controller_ComponentSimplified parent) {
            this.parent = parent;
        }
    ...
    public Controller_ComponentSimplified() {
        sensors = new Sensors();
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case _CONTROLLER_COMPONENT___CONTROLLER_ISON_:
                return stateVector[0].ordinal() >= State._CONTROLLER_COMPONENT___CONTROLLER_ISON_.ordinal() && stateVector[0].ordinal() <= State._CONTROLLER_COMPONENT___CONTROLLER_ISON___CONTROLLER_RECEIVING_AND_SENDING_SIGNALS___TRIGGER_ACTUATOR_.ordinal();
            case _CONTROLLER_COMPONENT___CONTROLLER_ISON___CONTROLLER_RECEIVING_AND_SENDING_SIGNALS___READING_SENSOR_DATA_:
