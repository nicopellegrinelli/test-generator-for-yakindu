...
public class Test_remove_unnecessary_nesting_transfer_transitionsSimplified implements IEventDriven {

    public enum State {

        MAIN_REGION_C, MAIN_REGION_C_D_B, MAIN_REGION_A, $NULLSTATE$
    }
    ...
    public Test_remove_unnecessary_nesting_transfer_transitionsSimplified() {
        for (int i = 0; i < 1; i++) {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case MAIN_REGION_C:
                return stateVector[0].ordinal() >= State.MAIN_REGION_C.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_C_D_B.ordinal();
            case MAIN_REGION_C_D_B:
