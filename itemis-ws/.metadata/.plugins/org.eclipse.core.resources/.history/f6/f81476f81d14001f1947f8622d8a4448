...
public class MotionDetectionSimplified implements ITimed, ICycleBased {
    ...
    private static class TimeEventsEvBuf {
        ...
        private boolean motionDetection_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0;
    }

    private static class MotionDetectionEvBuf {
    ...
    private MotionDetectionEvBuf current = new MotionDetectionEvBuf();
    ...
    public MotionDetectionSimplified() {
        user = new User();
        sensor = new Sensor();
        ...
        clearInEvents();
        /* Default init sequence for statechart motionDetection */
        setBrightness(0l);
        isExecuting = false;
    }
    ...
    public void enter() {
        ...
        isExecuting = true;
        /* Default enter sequence for statechart motionDetection */
    ...
    public void exit() {
        ...
        isExecuting = true;
        /* Default exit sequence for statechart motionDetection */
    ...
    private void swapInEvents() {
        ...
        current.timeEvents.motionDetection_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0 = timeEvents[0];
        timeEvents[0] = false;
    }
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            ...
            case MAIN_REGION_AUTOMATICMODE:
                return stateVector[0].ordinal() >= State.MAIN_REGION_AUTOMATICMODE.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_AUTOMATICMODE_R1_MOTIONDETECTIONMODE_R1_MOTIONDETECTED.ordinal();
            case MAIN_REGION_AUTOMATICMODE_R1_TWILIGHTDETECTIONMODE:
                return stateVector[0].ordinal() >= State.MAIN_REGION_AUTOMATICMODE_R1_TWILIGHTDETECTIONMODE.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_AUTOMATICMODE_R1_TWILIGHTDETECTIONMODE_R1_TWILIGHTDETECTED.ordinal();
            case MAIN_REGION_AUTOMATICMODE_R1_TWILIGHTDETECTIONMODE_R1_IDLE:
            ...
            case MAIN_REGION_AUTOMATICMODE_R1_MOTIONDETECTIONMODE:
                return stateVector[0].ordinal() >= State.MAIN_REGION_AUTOMATICMODE_R1_MOTIONDETECTIONMODE.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_AUTOMATICMODE_R1_MOTIONDETECTIONMODE_R1_MOTIONDETECTED.ordinal();
            case MAIN_REGION_AUTOMATICMODE_R1_MOTIONDETECTIONMODE_R1_IDLE:
    ...
    private long main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_react(long transitioned_before) {
        ...
        long transitioned_after = transitioned_before;
        if (transitioned_after < 0l) {
            if (current.timeEvents.motionDetection_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0) {
                exitSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected();
                current.timeEvents.motionDetection_main_region_AutomaticMode_r1_MotionDetectionMode_r1_MotionDetected_time_event_0 = false;
                enterSequence_main_region_AutomaticMode_r1_MotionDetectionMode_r1_Idle_default();
                main_region_AutomaticMode_r1_MotionDetectionMode_react(0l);
                transitioned_after = 0l;
            } else {
