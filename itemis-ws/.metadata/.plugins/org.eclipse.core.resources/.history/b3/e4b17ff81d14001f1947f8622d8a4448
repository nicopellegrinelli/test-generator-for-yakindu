...
public class Statechart13Simplified implements ITimed, IEventDriven {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case MAIN_REGION_CONTROLLER:
                return stateVector[0].ordinal() >= State.MAIN_REGION_CONTROLLER.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_CONTROLLER_R2_POLICE_INTERUPT_2.ordinal();
            case MAIN_REGION_CONTROLLER_R1_SMART_AND_DUMB_MODE:
                return stateVector[0].ordinal() >= State.MAIN_REGION_CONTROLLER_R1_SMART_AND_DUMB_MODE.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_CONTROLLER_R1_SMART_AND_DUMB_MODE_R1_GREEN_R1_SENSOR_RECHECK.ordinal();
            case MAIN_REGION_CONTROLLER_R1_SMART_AND_DUMB_MODE_R1_RED:
            ...
            case MAIN_REGION_CONTROLLER_R1_SMART_AND_DUMB_MODE_R1_GREEN:
                return stateVector[0].ordinal() >= State.MAIN_REGION_CONTROLLER_R1_SMART_AND_DUMB_MODE_R1_GREEN.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_CONTROLLER_R1_SMART_AND_DUMB_MODE_R1_GREEN_R1_SENSOR_RECHECK.ordinal();
            case MAIN_REGION_CONTROLLER_R1_SMART_AND_DUMB_MODE_R1_GREEN_R1_SENSOR_CHECK:
            ...
            case MAIN_REGION_CONTROLLER_R1_POLICE_MODE:
                return stateVector[0].ordinal() >= State.MAIN_REGION_CONTROLLER_R1_POLICE_MODE.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_CONTROLLER_R1_POLICE_MODE_R1_YELLOW_OFF.ordinal();
            case MAIN_REGION_CONTROLLER_R1_POLICE_MODE_R1_YELLOW_ON:
    ...
    private void raiseSetGreen(boolean value) {
        setGreenValue = value;
        setGreen = true;
    ...
    private Observable<Boolean> getSetGreen() {
    ...
    private void raiseSetYellow(boolean value) {
    ...
    private Observable<Boolean> getSetYellow() {
    ...
    private void raiseSetRed(boolean value) {
        setRedValue = value;
        setRed = true;
    ...
    private Observable<Boolean> getSetRed() {
    ...
    private void raiseSetLED(boolean value) {
        setLEDValue = value;
        setLED = true;
    ...
    private Observable<Boolean> getSetLED() {
    ...
    private boolean getSmartMode() {
        return smartMode;
    }

    private void setSmartMode(boolean value) {
        this.smartMode = value;
    }

    private boolean policeMode;

    private boolean getPoliceMode() {
        return policeMode;
    }

    private void setPoliceMode(boolean value) {
        this.policeMode = value;
    }

    private boolean carDetection;

    private boolean getCarDetection() {
        return carDetection;
    }

    private void setCarDetection(boolean value) {
