...
public class Statechart5Simplified implements ITimed, IEventDriven {
    ...
    public static class ButtonActuation {
        ...
        private Statechart5Simplified parent;

        public ButtonActuation(Statechart5Simplified parent) {
            this.parent = parent;
        }
    ...
    public static class ButtonCancel {
        ...
        public ButtonCancel(Statechart5Simplified parent) {
            this.parent = parent;
        }
    ...
    private LedRed ledRed;

    private LedGreen ledGreen;

    private ButtonActuation buttonActuation;
