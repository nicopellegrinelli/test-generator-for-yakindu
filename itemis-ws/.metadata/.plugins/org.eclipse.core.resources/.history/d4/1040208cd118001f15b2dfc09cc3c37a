...
public class LEDLight_UnitSimplified implements ITimed, IEventDriven {

    public static class Device {

        private LEDLight_UnitSimplified parent;

        public Device(LEDLight_UnitSimplified parent) {
            this.parent = parent;
        }
    ...
    public static class Brightness {
        ...
        public Brightness(LEDLight_UnitSimplified parent) {
            this.parent = parent;
        }
    ...
    public LEDLight_UnitSimplified() {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            ...
            case _LED_LIGHT_UNIT___ON_:
                return stateVector[0].ordinal() >= State._LED_LIGHT_UNIT___ON_.ordinal() && stateVector[0].ordinal() <= State._LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__LUMINOSITY__CHANGE_LUMINOSITY_LEVEL.ordinal();
            case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON_STANDBY:
            ...
            case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON:
                return stateVector[0].ordinal() >= State._LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON.ordinal() && stateVector[0].ordinal() <= State._LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__LUMINOSITY__CHANGE_LUMINOSITY_LEVEL.ordinal();
            case _LED_LIGHT_UNIT___ON___BULB_STATUS__BULB_ON__LUMINOSITY__CHANGE_LUMINOSITY_LEVEL:
