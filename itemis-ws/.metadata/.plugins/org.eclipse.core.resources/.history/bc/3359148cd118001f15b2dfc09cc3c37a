...
public class SmartLightSystemSimplified implements ITimed, IEventDriven {

    public static class System {

        private SmartLightSystemSimplified parent;

        public System(SmartLightSystemSimplified parent) {
            this.parent = parent;
        }
    ...
    public SmartLightSystemSimplified() {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM:
                return stateVector[0].ordinal() >= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM.ordinal() && stateVector[0].ordinal() <= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_TRACKINGDEVICETEMPERATURE_OFF.ordinal();
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_SYSTEMSTATUS_OFF:
            ...
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_CONTROLLERCOMPONENT__INITIALIZE_CONTROLLER_COMPONENT_:
                return stateVector[2].ordinal() >= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_CONTROLLERCOMPONENT__INITIALIZE_CONTROLLER_COMPONENT_.ordinal() && stateVector[2].ordinal() <= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_CONTROLLERCOMPONENT__INITIALIZE_CONTROLLER_COMPONENT__UPDATING__CONTROLLER_UPDATES_.ordinal();
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_CONTROLLERCOMPONENT__INITIALIZE_CONTROLLER_COMPONENT__UPDATING__CONTROLLER_UPDATES_:
            ...
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_PHYSICALENTITY__INITIALIZE_SENSOR_COMPONENT_:
                return stateVector[3].ordinal() >= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_PHYSICALENTITY__INITIALIZE_SENSOR_COMPONENT_.ordinal() && stateVector[3].ordinal() <= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_PHYSICALENTITY__INITIALIZE_SENSOR_COMPONENT__UPDATING__SENSOR_UPDATES_.ordinal();
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_PHYSICALENTITY__INITIALIZE_SENSOR_COMPONENT__UPDATING__SENSOR_UPDATES_:
            ...
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_NETWORKCOMPONENT__INITIALIZE_WIFI_COMPONENT_:
                return stateVector[4].ordinal() >= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_NETWORKCOMPONENT__INITIALIZE_WIFI_COMPONENT_.ordinal() && stateVector[4].ordinal() <= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_NETWORKCOMPONENT__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_.ordinal();
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_NETWORKCOMPONENT__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_:
            ...
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT_:
                return stateVector[5].ordinal() >= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT_.ordinal() && stateVector[5].ordinal() <= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT__UPDATING__POWER_UPDATES_.ordinal();
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT__UPDATING__POWER_UPDATES_:
            ...
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_TRACKINGDEVICETEMPERATURE__INITIALIZE_DEVICETEMP_COMPONENT_:
                return stateVector[6].ordinal() >= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_TRACKINGDEVICETEMPERATURE__INITIALIZE_DEVICETEMP_COMPONENT_.ordinal() && stateVector[6].ordinal() <= State._SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_TRACKINGDEVICETEMPERATURE__INITIALIZE_DEVICETEMP_COMPONENT__UPDATING__TEMPERATURE_UPDATES_.ordinal();
            case _SMARTLIGHTSYSTEM__SMARTLIGHTSYSTEM_TRACKINGDEVICETEMPERATURE__INITIALIZE_DEVICETEMP_COMPONENT__UPDATING__TEMPERATURE_UPDATES_:
    ...
    private Ultrasonic_MotionDetector getMotionDetector() {
    ...
    private LEDLight_Unit getLights() {
        return lights;
    }
