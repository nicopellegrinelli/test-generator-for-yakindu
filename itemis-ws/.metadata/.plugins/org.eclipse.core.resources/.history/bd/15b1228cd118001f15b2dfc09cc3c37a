...
public class SmartLightHUBSimplified implements ITimed, IEventDriven {

    public static class HUB {

        private SmartLightHUBSimplified parent;

        public HUB(SmartLightHUBSimplified parent) {
            this.parent = parent;
        }
    ...
    public static class Network {
        ...
        public Network(SmartLightHUBSimplified parent) {
            this.parent = parent;
        }
        ...
        private void setConnection(boolean value) {
    ...
    public static class System1 {
        ...
        public System1(SmartLightHUBSimplified parent) {
            this.parent = parent;
        }
    ...
    public static class System2 {
        ...
        public System2(SmartLightHUBSimplified parent) {
            this.parent = parent;
        }
    ...
    public SmartLightHUBSimplified() {
        hUB = new HUB(this);
        power = new Power();
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            ...
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB:
                return stateVector[0].ordinal() >= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB.ordinal() && stateVector[0].ordinal() <= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_LIGHT2REGION_LED2_STATUS_ERROR.ordinal();
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_SMARTHUBSTATUSREGION_SMARTLIGHTHUBSYSTEMSTATUS:
                return stateVector[0].ordinal() >= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_SMARTHUBSTATUSREGION_SMARTLIGHTHUBSYSTEMSTATUS.ordinal() && stateVector[0].ordinal() <= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_SMARTHUBSTATUSREGION_SMARTLIGHTHUBSYSTEMSTATUS_HUBSTATUSREGION_SYSTEM_MANAGER_SYSTEM2_LED_LIGHT2_OFF.ordinal();
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_SMARTHUBSTATUSREGION_SMARTLIGHTHUBSYSTEMSTATUS_HUBSTATUSREGION_ALLSYSTEMSOFF:
            ...
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_SMARTHUBSTATUSREGION_SMARTLIGHTHUBSYSTEMSTATUS_HUBSTATUSREGION_SYSTEM_MANAGER:
                return stateVector[0].ordinal() >= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_SMARTHUBSTATUSREGION_SMARTLIGHTHUBSYSTEMSTATUS_HUBSTATUSREGION_SYSTEM_MANAGER.ordinal() && stateVector[0].ordinal() <= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_SMARTHUBSTATUSREGION_SMARTLIGHTHUBSYSTEMSTATUS_HUBSTATUSREGION_SYSTEM_MANAGER_SYSTEM2_LED_LIGHT2_OFF.ordinal();
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_SMARTHUBSTATUSREGION_SMARTLIGHTHUBSYSTEMSTATUS_HUBSTATUSREGION_SYSTEM_MANAGER_SYSTEM1_LED_LIGHT1_ON:
            ...
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_POWERCONSUMPTIONREGION_IOT_ENERGYSAVERMANAGER:
                return stateVector[2].ordinal() >= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_POWERCONSUMPTIONREGION_IOT_ENERGYSAVERMANAGER.ordinal() && stateVector[2].ordinal() <= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_POWERCONSUMPTIONREGION_IOT_ENERGYSAVERMANAGER_TURNINGOFF_DEVICE_OVERTHRESHOLD__FINAL_.ordinal();
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_POWERCONSUMPTIONREGION_IOT_ENERGYSAVERMANAGER_TURNINGOFF_DEVICE_OVERTHRESHOLD_LED_LIGHT1:
            ...
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_LIGHT1REGION_LED1:
                return stateVector[4].ordinal() >= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_LIGHT1REGION_LED1.ordinal() && stateVector[4].ordinal() <= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_LIGHT1REGION_LED1_STATUS_ERROR.ordinal();
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_LIGHT1REGION_LED1_STATUS_WORKING:
            ...
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_LIGHT2REGION_LED2:
                return stateVector[5].ordinal() >= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_LIGHT2REGION_LED2.ordinal() && stateVector[5].ordinal() <= State.SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_LIGHT2REGION_LED2_STATUS_ERROR.ordinal();
            case SMARTLIGHTHUBSYSTEM_1_0_SMARTLIGHTSHUB_LIGHT2REGION_LED2_STATUS_WORKING:
    ...
    private SmartLightSystem getLED1() {
        return lED1;
    }
    ...
    private SmartLightSystem getLED2() {
        return lED2;
    }
