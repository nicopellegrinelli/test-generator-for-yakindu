...
public class DSimplified implements ITimed, IEventDriven {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case MAIN_REGION_ORTHOGONAL:
                return stateVector[0].ordinal() >= State.MAIN_REGION_ORTHOGONAL.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_ORTHOGONAL_R2_T.ordinal();
            case MAIN_REGION_ORTHOGONAL_R1_TEMP:
