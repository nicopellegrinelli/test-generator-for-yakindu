...
public class Cyclebased implements ITimed, ICycleBased {
	private static class EvBuf {
		private boolean input;
	}
	private static class TimeEventsEvBuf {
		private boolean cyclebased_main_region_StateB_time_event_0;
		private boolean cyclebased_main_region_StateC_time_event_0;
		private boolean cyclebased_main_region_StateC_time_event_1;
	}
	private static class CyclebasedEvBuf {
	...
	private CyclebasedEvBuf current = new CyclebasedEvBuf();
	...
	public void enter() {
		...
		isExecuting = true;
		/* Default enter sequence for statechart cyclebased */
	...
	public void exit() {
		...
		isExecuting = true;
		/* Default exit sequence for statechart cyclebased */
	...
	*/
	...
	private void swapInEvents() {
		current.iface.input = input;
		input = false;
		current.timeEvents.cyclebased_main_region_StateB_time_event_0 = timeEvents[0];
		timeEvents[0] = false;
		current.timeEvents.cyclebased_main_region_StateC_time_event_0 = timeEvents[1];
		timeEvents[1] = false;
		current.timeEvents.cyclebased_main_region_StateC_time_event_1 = timeEvents[2];
		timeEvents[2] = false;
	}
	...
	*/
	...
	private long main_region_StateB_react(long transitioned_before) {
		...
		long transitioned_after = transitioned_before;
		if (transitioned_after<0l) {
			if (current.timeEvents.cyclebased_main_region_StateB_time_event_0) {
				exitSequence_main_region_StateB();
				current.timeEvents.cyclebased_main_region_StateB_time_event_0 = false;
	...
	private long main_region_StateC_react(long transitioned_before) {
		...
		long transitioned_after = transitioned_before;
		if (transitioned_after<0l) {
			if (current.timeEvents.cyclebased_main_region_StateC_time_event_0) {
				exitSequence_main_region_StateC();
				current.timeEvents.cyclebased_main_region_StateC_time_event_0 = false;
				enterSequence_main_region_StateE_default();
				react(0l);
				transitioned_after = 0l;
			} else {
				if (current.timeEvents.cyclebased_main_region_StateC_time_event_1) {
					exitSequence_main_region_StateC();
					current.timeEvents.cyclebased_main_region_StateC_time_event_1 = false;
