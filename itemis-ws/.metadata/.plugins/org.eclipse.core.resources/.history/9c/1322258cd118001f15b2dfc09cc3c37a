...
public class AirConditioner_UnitSimplified implements ITimed, IEventDriven {

    public static class Metric {

        private AirConditioner_UnitSimplified parent;

        public Metric(AirConditioner_UnitSimplified parent) {
            this.parent = parent;
        }
    ...
    public static class Heat {
        ...
        public Heat(AirConditioner_UnitSimplified parent) {
            this.parent = parent;
        }
    ...
    public static class Cool {
        ...
        public Cool(AirConditioner_UnitSimplified parent) {
            this.parent = parent;
        }
    ...
    public AirConditioner_UnitSimplified() {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            ...
            case _AIRCONDITIONER__MONITORROOMTEMP:
                return stateVector[0].ordinal() >= State._AIRCONDITIONER__MONITORROOMTEMP.ordinal() && stateVector[0].ordinal() <= State._AIRCONDITIONER__MONITORROOMTEMP_CHANGINGTEMP_DECREASETEMP.ordinal();
            case _AIRCONDITIONER__MONITORROOMTEMP_MONITORINGTEMP_MAINTAINING:
            ...
            case _AIRCONDITIONER__MONITORROOMTEMP_MONITORINGTEMP_ROOMTEMPCHANGING:
                return stateVector[0].ordinal() >= State._AIRCONDITIONER__MONITORROOMTEMP_MONITORINGTEMP_ROOMTEMPCHANGING.ordinal() && stateVector[0].ordinal() <= State._AIRCONDITIONER__MONITORROOMTEMP_MONITORINGTEMP_ROOMTEMPCHANGING_TEMPERATURECHANGE_COOLDOWN.ordinal();
            case _AIRCONDITIONER__MONITORROOMTEMP_MONITORINGTEMP_ROOMTEMPCHANGING_TEMPERATURECHANGE_HEATINGUP:
    ...
    private long getTempChange() {
        return tempChange;
    }

    private void setTempChange(long value) {
        this.tempChange = value;
    }

    private long roomTemp;

    private long getRoomTemp() {
        return roomTemp;
    }

    private void setRoomTemp(long value) {
        this.roomTemp = value;
    }
