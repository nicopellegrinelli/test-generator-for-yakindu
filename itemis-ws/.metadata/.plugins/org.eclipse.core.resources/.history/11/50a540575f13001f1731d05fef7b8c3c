...
public class ESimplified implements ITimed, IEventDriven {

    public enum State {

        MAIN_REGION_ORTHOGONALSTATE, MAIN_REGION_ORTHOGONALSTATE_R1_STATEA, MAIN_REGION_ORTHOGONALSTATE_R2_STATEB, $NULLSTATE$
    }
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case MAIN_REGION_ORTHOGONALSTATE:
                return stateVector[0].ordinal() >= State.MAIN_REGION_ORTHOGONALSTATE.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_ORTHOGONALSTATE_R2_STATEB.ordinal();
            case MAIN_REGION_ORTHOGONALSTATE_R1_STATEA:
