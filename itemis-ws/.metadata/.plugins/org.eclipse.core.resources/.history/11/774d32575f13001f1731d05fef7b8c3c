...
public class Test32Simplified implements ITimed, IEventDriven {

    public static class Panel {

        private Test32Simplified parent;

        public Panel(Test32Simplified parent) {
            this.parent = parent;
        }
    ...
    public static class Error {
        ...
        private Observable<Void> getMotor_error() {
    ...
    public enum State {
        ...
        MAIN_REGION_STANDARD, MAIN_REGION_PAUSE, $NULLSTATE$
    }
