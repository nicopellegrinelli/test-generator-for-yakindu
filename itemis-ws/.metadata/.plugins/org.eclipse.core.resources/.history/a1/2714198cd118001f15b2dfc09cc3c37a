...
public class Microwave_UnitSimplified implements ITimed, IEventDriven {

    public static class Device {

        private Microwave_UnitSimplified parent;

        public Device(Microwave_UnitSimplified parent) {
            this.parent = parent;
        }
    ...
    public static class Door {
        ...
        public Door(Microwave_UnitSimplified parent) {
            this.parent = parent;
        }
    ...
    public Microwave_UnitSimplified() {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            ...
            case _MICROWAVE_UNIT___ON_:
                return stateVector[0].ordinal() >= State._MICROWAVE_UNIT___ON_.ordinal() && stateVector[0].ordinal() <= State._MICROWAVE_UNIT___ON__DOORSTATUS_DOOROPENED.ordinal();
            case _MICROWAVE_UNIT___ON___MICROWAVE_ISWORKING__IDLE_STANDBY:
            ...
            case _MICROWAVE_UNIT___ON___MICROWAVE_ISWORKING__STARTTIMER:
                return stateVector[0].ordinal() >= State._MICROWAVE_UNIT___ON___MICROWAVE_ISWORKING__STARTTIMER.ordinal() && stateVector[0].ordinal() <= State._MICROWAVE_UNIT___ON___MICROWAVE_ISWORKING__STARTTIMER__STARTING_TIMER__START.ordinal();
            case _MICROWAVE_UNIT___ON___MICROWAVE_ISWORKING__STARTTIMER__STARTING_TIMER__PAUSE:
    ...
    private boolean getFood_inside_sensed() {
        return food_inside_sensed;
    }

    private void setFood_inside_sensed(boolean value) {
        this.food_inside_sensed = value;
    }

    private boolean in_use;

    private boolean getIn_use() {
        return in_use;
    }

    private void setIn_use(boolean value) {
        this.in_use = value;
    }
