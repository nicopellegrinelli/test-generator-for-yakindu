...
public class SmartTemplate_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart.SmartTemplate"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SmartTemplate_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "statechart.SmartTemplate$State",
      "statechart.DeviceTemp_Component$1",
      "statechart.Controller_Component$Actuator",
      "statechart.SmartTemplate$SensorOutput",
      "statechart.SmartTemplate$System",
      "statechart.SmartTemplate$SensorInput",
      "com.yakindu.core.ITimerService",
      "statechart.DeviceTemp_Component$Heat",
      "statechart.SmartTemplate$1"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SmartTemplate_ESTest_scaffolding.class.getClassLoader()); 
