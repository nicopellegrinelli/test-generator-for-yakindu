...
public class Statechart3Simplified implements ITimed, IEventDriven {
    ...
    public static class Pir {
        ...
        private Statechart3Simplified parent;

        public Pir(Statechart3Simplified parent) {
            this.parent = parent;
        }
