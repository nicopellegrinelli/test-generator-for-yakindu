...
public class Actuator_ComponentSimplified implements ITimed, IEventDriven {

    public static class Power {

        private long deviceInput;

        private long getDeviceInput() {
            return deviceInput;
        }

        private void setDeviceInput(long value) {
        ...
        private void setRequired(long value) {
            this.required = value;
        }
    }
    ...
    public static class Device {
        ...
        private boolean getActuated() {
            return actuated;
        }

        private void setActuated(boolean value) {
            this.actuated = value;
        }
    }
    ...
    public Actuator_ComponentSimplified() {
        power = new Power();
        device = new Device();
        for (int i = 0; i < 1; i++) {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            ...
            case _ACTUATOR_COMPONENT___ACTUATORRECEIVINGSIGNAL_:
                return stateVector[0].ordinal() >= State._ACTUATOR_COMPONENT___ACTUATORRECEIVINGSIGNAL_.ordinal() && stateVector[0].ordinal() <= State._ACTUATOR_COMPONENT___ACTUATORRECEIVINGSIGNAL___ACTUATOR_RECEIVES_ACTUATINGSIGNAL_FROM_CONTROLLER___ERROR_HANDLER_.ordinal();
    ...
    private void setIsTriggered(boolean value) {
