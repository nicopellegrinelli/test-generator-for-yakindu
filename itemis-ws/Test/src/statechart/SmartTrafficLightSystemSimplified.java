...
public class SmartTrafficLightSystemSimplified implements ITimed, IEventDriven {

    public static class System {

        private SmartTrafficLightSystemSimplified parent;

        public System(SmartTrafficLightSystemSimplified parent) {
            this.parent = parent;
        }
        ...
        private String getLight_status() {
            return light_status;
        }

        private void setLight_status(String value) {
            this.light_status = value;
        }

        private String crossing_status;

        private String getCrossing_status() {
            return crossing_status;
        }

        private void setCrossing_status(String value) {
    ...
    public static class SensorInput {
        ...
        private long getDetection_time() {
            return detection_time;
        }

        private void setDetection_time(long value) {
            this.detection_time = value;
        }

        private long timeout_time;

        private long getTimeout_time() {
            return timeout_time;
        }

        private void setTimeout_time(long value) {
    ...
    private void setActuator(Actuator_Component value) {
        this.actuator = value;
    }
    ...
    private void setController(Controller_Component value) {
        this.controller = value;
    }

    private Sensor_Component sensor;

    private Sensor_Component getSensor() {
        return sensor;
    }

    private void setSensor(Sensor_Component value) {
        this.sensor = value;
    }
    ...
    private void setWiFi(Network_Component value) {
        this.wiFi = value;
    }
    ...
    private void setPower(Power_Component value) {
        this.power = value;
    }
    ...
    private void setTemp(DeviceTemp_Component value) {
        this.temp = value;
    }

    private TrafficLight_Unit trafficLight;

    private TrafficLight_Unit getTrafficLight() {
        return trafficLight;
    }

    private void setTrafficLight(TrafficLight_Unit value) {
    ...
    public SmartTrafficLightSystemSimplified() {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM:
                return stateVector[0].ordinal() >= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_TRACKINGDEVICETEMPERATURE_OFF.ordinal();
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_SYSTEMSTATUS_OFF:
            ...
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_CONTROLLERCOMPONENT__INITIALIZE_CONTROLLER_COMPONENT_:
                return stateVector[2].ordinal() >= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_CONTROLLERCOMPONENT__INITIALIZE_CONTROLLER_COMPONENT_.ordinal() && stateVector[2].ordinal() <= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_CONTROLLERCOMPONENT__INITIALIZE_CONTROLLER_COMPONENT__UPDATING__CONTROLLER_UPDATES_.ordinal();
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_CONTROLLERCOMPONENT__INITIALIZE_CONTROLLER_COMPONENT__UPDATING__CONTROLLER_UPDATES_:
            ...
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT_:
                return stateVector[3].ordinal() >= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT_.ordinal() && stateVector[3].ordinal() <= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT__UPDATING__SENSOR_UPDATES_.ordinal();
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_SENSORCOMPONENT__INITIALIZE_SENSOR_COMPONENT__UPDATING__SENSOR_UPDATES_:
            ...
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT_:
                return stateVector[4].ordinal() >= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT_.ordinal() && stateVector[4].ordinal() <= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_.ordinal();
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_WIFIGATEWAY__INITIALIZE_WIFI_COMPONENT__UPDATING__WIFI_UPDATES_:
            ...
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT_:
                return stateVector[5].ordinal() >= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT_.ordinal() && stateVector[5].ordinal() <= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT__UPDATING__POWER_UPDATES_.ordinal();
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT__UPDATING__POWER_UPDATES_:
            ...
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_TRACKINGDEVICETEMPERATURE__INITIALIZE_DEVICETEMP_COMPONENT_:
                return stateVector[6].ordinal() >= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_TRACKINGDEVICETEMPERATURE__INITIALIZE_DEVICETEMP_COMPONENT_.ordinal() && stateVector[6].ordinal() <= State.MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_TRACKINGDEVICETEMPERATURE__INITIALIZE_DEVICETEMP_COMPONENT__UPDATING__TEMPERATURE_UPDATES_.ordinal();
            case MAIN_REGION_SMARTTRAFFICLIGHTSYSTEM_TRACKINGDEVICETEMPERATURE__INITIALIZE_DEVICETEMP_COMPONENT__UPDATING__TEMPERATURE_UPDATES_:
