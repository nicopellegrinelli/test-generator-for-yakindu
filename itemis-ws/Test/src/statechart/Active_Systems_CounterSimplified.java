...
public class Active_Systems_CounterSimplified implements IEventDriven {

    public static class Counter {

        private long activeSystems;

        private long getActiveSystems() {
            return activeSystems;
        }

        private void setActiveSystems(long value) {
            this.activeSystems = value;
        }

        private long inactiveSystems;

        private long getInactiveSystems() {
            return inactiveSystems;
        }

        private void setInactiveSystems(long value) {
    ...
    public enum State {
        ...
        MAIN_REGION_STATICUPDATE, $NULLSTATE$
    }
    ...
    public Active_Systems_CounterSimplified() {
        counter = new Counter();
        for (int i = 0; i < 1; i++) {
