...
public class Network_ComponentSimplified implements ITimed, IEventDriven {
    ...
    public Network_ComponentSimplified() {
        for (int i = 0; i < 1; i++) {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case _NETWORK_COMPONENT___NETWORK_COMPONENT_WORKING_:
                return stateVector[0].ordinal() >= State._NETWORK_COMPONENT___NETWORK_COMPONENT_WORKING_.ordinal() && stateVector[0].ordinal() <= State._NETWORK_COMPONENT___NETWORK_COMPONENT_WORKING___NETWORK_CONNECTION__NETWORKTIMEOUT.ordinal();
            case _NETWORK_COMPONENT___NETWORK_COMPONENT_WORKING___NETWORK_CONNECTION__CHECKINGFORNETWORKCONNECTION:
                return stateVector[0].ordinal() >= State._NETWORK_COMPONENT___NETWORK_COMPONENT_WORKING___NETWORK_CONNECTION__CHECKINGFORNETWORKCONNECTION.ordinal() && stateVector[0].ordinal() <= State._NETWORK_COMPONENT___NETWORK_COMPONENT_WORKING___NETWORK_CONNECTION__CHECKINGFORNETWORKCONNECTION__CHECKINGFORCONNECTIONUPDATES__CONNECTINGTOSERVER__SERVER_CONNECTION__FAILURE.ordinal();
            case _NETWORK_COMPONENT___NETWORK_COMPONENT_WORKING___NETWORK_CONNECTION__CHECKINGFORNETWORKCONNECTION__CHECKINGFORCONNECTIONUPDATES__CONNECTINGTOSERVER:
                return stateVector[0].ordinal() >= State._NETWORK_COMPONENT___NETWORK_COMPONENT_WORKING___NETWORK_CONNECTION__CHECKINGFORNETWORKCONNECTION__CHECKINGFORCONNECTIONUPDATES__CONNECTINGTOSERVER.ordinal() && stateVector[0].ordinal() <= State._NETWORK_COMPONENT___NETWORK_COMPONENT_WORKING___NETWORK_CONNECTION__CHECKINGFORNETWORKCONNECTION__CHECKINGFORCONNECTIONUPDATES__CONNECTINGTOSERVER__SERVER_CONNECTION__FAILURE.ordinal();
            case _NETWORK_COMPONENT___NETWORK_COMPONENT_WORKING___NETWORK_CONNECTION__CHECKINGFORNETWORKCONNECTION__CHECKINGFORCONNECTIONUPDATES__CONNECTINGTOSERVER__SERVER_CONNECTION__SUCCESS:
    ...
    private long getTimeout_counter() {
        return timeout_counter;
    }

    private void setTimeout_counter(long value) {
        this.timeout_counter = value;
    }

    private long timeout_value;

    private long getTimeout_value() {
        return timeout_value;
    }

    private void setTimeout_value(long value) {
        this.timeout_value = value;
    }

    private long reconnect_value;

    private long getReconnect_value() {
        return reconnect_value;
    }

    private void setReconnect_value(long value) {
