...
public class LampadaSimplified implements IEventDriven {

    public enum State {

        MAIN_REGION_OFF, MAIN_REGION_STANDBY, MAIN_REGION_ON, $NULLSTATE$
    }
    ...
    private Observable<Void> getTeardown() {
