...
public class Statechart14Simplified implements ITimed, IEventDriven {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case MAIN_REGION_ORTHOGONAL:
                return stateVector[0].ordinal() >= State.MAIN_REGION_ORTHOGONAL.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_INTERRUPTED_R1_ALLBLACK.ordinal();
            case MAIN_REGION_ORTHOGONAL_TOGGLE_MODE_BUTTON_NOT_PRESSED:
            ...
            case MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_NORMAL:
                return stateVector[1].ordinal() >= State.MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_NORMAL.ordinal() && stateVector[1].ordinal() <= State.MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_NORMAL_R1_SMART_GREEN_R1_GREEN.ordinal();
            case MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_NORMAL_R1_RED:
            ...
            case MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_NORMAL_R1_SMART_GREEN:
                return stateVector[1].ordinal() >= State.MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_NORMAL_R1_SMART_GREEN.ordinal() && stateVector[1].ordinal() <= State.MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_NORMAL_R1_SMART_GREEN_R1_GREEN.ordinal();
            case MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_NORMAL_R1_SMART_GREEN_R1_GREEN:
            ...
            case MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_INTERRUPTED:
                return stateVector[1].ordinal() >= State.MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_INTERRUPTED.ordinal() && stateVector[1].ordinal() <= State.MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_INTERRUPTED_R1_ALLBLACK.ordinal();
            case MAIN_REGION_ORTHOGONAL_TRAFFIC_LIGHT_MODES_INTERRUPTED_R1_YELLOW:
    ...
    private void raisePoliceInterrupt() {
        internalEventQueue.add(() -> {
            policeInterrupt = true;
        });
    }

    private void raiseLocal_setLED(final boolean value) {
        internalEventQueue.add(() -> {
    ...
    private boolean getLocal_setLEDValue() {
        if (!local_setLED)
