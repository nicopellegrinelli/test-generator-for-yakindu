...
public class PhysicalEntity_TemplateSimplified implements ITimed, IEventDriven {

    public static class Status {

        private PhysicalEntity_TemplateSimplified parent;

        public Status(PhysicalEntity_TemplateSimplified parent) {
            this.parent = parent;
        }
    ...
    public static class Trigger {
        ...
        public Trigger(PhysicalEntity_TemplateSimplified parent) {
            this.parent = parent;
        }
    ...
    public PhysicalEntity_TemplateSimplified() {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case PHYSICALENTITY_TEMPLATE__DETECTING_:
                return stateVector[0].ordinal() >= State.PHYSICALENTITY_TEMPLATE__DETECTING_.ordinal() && stateVector[0].ordinal() <= State.PHYSICALENTITY_TEMPLATE__DETECTING__POWER_POWERSUPPLYSTATUS_STATUS_CIRCUITTRIGGER.ordinal();
            case PHYSICALENTITY_TEMPLATE__DETECTING__SENSOR_TRANSMITTING:
            ...
            case PHYSICALENTITY_TEMPLATE__DETECTING__CONTROLLER_READING_SENSOR_DATA:
                return stateVector[1].ordinal() >= State.PHYSICALENTITY_TEMPLATE__DETECTING__CONTROLLER_READING_SENSOR_DATA.ordinal() && stateVector[1].ordinal() <= State.PHYSICALENTITY_TEMPLATE__DETECTING__CONTROLLER_READING_SENSOR_DATA_PROCESSING_COMPARING.ordinal();
            case PHYSICALENTITY_TEMPLATE__DETECTING__CONTROLLER_READING_SENSOR_DATA_PROCESSING_TRIGGER_CHANGED:
            ...
            case PHYSICALENTITY_TEMPLATE__DETECTING__POWER_POWERSUPPLYSTATUS:
                return stateVector[3].ordinal() >= State.PHYSICALENTITY_TEMPLATE__DETECTING__POWER_POWERSUPPLYSTATUS.ordinal() && stateVector[3].ordinal() <= State.PHYSICALENTITY_TEMPLATE__DETECTING__POWER_POWERSUPPLYSTATUS_STATUS_CIRCUITTRIGGER.ordinal();
            case PHYSICALENTITY_TEMPLATE__DETECTING__POWER_POWERSUPPLYSTATUS_STATUS_CONSUMINGMINIMUM:
