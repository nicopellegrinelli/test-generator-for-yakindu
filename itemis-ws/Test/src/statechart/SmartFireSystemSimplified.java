...
public class SmartFireSystemSimplified implements ITimed, IEventDriven {

    public static class System {

        private SmartFireSystemSimplified parent;

        public System(SmartFireSystemSimplified parent) {
            this.parent = parent;
        }
        ...
        private boolean getAlarm_status() {
            return alarm_status;
        }

        private void setAlarm_status(boolean value) {
    ...
    public static class SensorInput {
        ...
        public SensorInput(SmartFireSystemSimplified parent) {
            this.parent = parent;
        }
        ...
        private long getSmoke_detection_time() {
            return smoke_detection_time;
        }

        private void setSmoke_detection_time(long value) {
            this.smoke_detection_time = value;
        }

        private long carbon_detection_time;

        private long getCarbon_detection_time() {
            return carbon_detection_time;
        }

        private void setCarbon_detection_time(long value) {
            this.carbon_detection_time = value;
        }

        private long heat_detection_time;

        private long getHeat_detection_time() {
            return heat_detection_time;
        }

        private void setHeat_detection_time(long value) {
    ...
    public static class SensorOutput {
        ...
        private void setDetected(String value) {
            this.detected = value;
        }
    }
    ...
    private CarbonSensorOutput carbonSensorOutput;

    private HeatSensorOutput heatSensorOutput;

    private SmokeSensorOutput smokeSensorOutput;
    ...
    public SmartFireSystemSimplified() {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM:
                return stateVector[0].ordinal() >= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM.ordinal() && stateVector[0].ordinal() <= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_DEVICETEMPERATURECOMPONENT_OFF.ordinal();
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM_DEVICESTATUS_OFF:
            ...
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM_CONTROLLERCOMPONENT__CONTROLLER_COMPONENT_ISON_:
                return stateVector[2].ordinal() >= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_CONTROLLERCOMPONENT__CONTROLLER_COMPONENT_ISON_.ordinal() && stateVector[2].ordinal() <= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_CONTROLLERCOMPONENT__CONTROLLER_COMPONENT_ISON___CONTROLLER_RECEIVING_AND_SENDING_UPDATES___CONTROLLER_COMPONENT_.ordinal();
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM_CONTROLLERCOMPONENT__CONTROLLER_COMPONENT_ISON___CONTROLLER_RECEIVING_AND_SENDING_UPDATES___CONTROLLER_COMPONENT_:
            ...
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM_SENSORCOMPONENT__SENSOR_COMPONENT_ISON_:
                return stateVector[3].ordinal() >= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_SENSORCOMPONENT__SENSOR_COMPONENT_ISON_.ordinal() && stateVector[3].ordinal() <= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_SENSORCOMPONENT__SENSOR_COMPONENT_ISON___SENSOR_MONITORING___SENSOR_COMPONENT___SENSOR_DETECTED_ACTIVITY___FINAL_.ordinal();
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM_SENSORCOMPONENT__SENSOR_COMPONENT_ISON___SENSOR_MONITORING___SENSOR_COMPONENT_:
                return stateVector[3].ordinal() >= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_SENSORCOMPONENT__SENSOR_COMPONENT_ISON___SENSOR_MONITORING___SENSOR_COMPONENT_.ordinal() && stateVector[3].ordinal() <= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_SENSORCOMPONENT__SENSOR_COMPONENT_ISON___SENSOR_MONITORING___SENSOR_COMPONENT___SENSOR_DETECTED_ACTIVITY___FINAL_.ordinal();
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM_SENSORCOMPONENT__SENSOR_COMPONENT_ISON___SENSOR_MONITORING___SENSOR_COMPONENT___SENSOR_DETECTED_ACTIVITY__CARBONDETECTED:
            ...
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM_NETWORKCOMPONENT__INITIALIZE_NETWORK_COMPONENT_:
                return stateVector[4].ordinal() >= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_NETWORKCOMPONENT__INITIALIZE_NETWORK_COMPONENT_.ordinal() && stateVector[4].ordinal() <= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_NETWORKCOMPONENT__INITIALIZE_NETWORK_COMPONENT___RECEIVING_NETWORK_CONNECTION_UPDATES___NETWORK_CONNECTION_UPDATES_.ordinal();
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM_NETWORKCOMPONENT__INITIALIZE_NETWORK_COMPONENT___RECEIVING_NETWORK_CONNECTION_UPDATES___NETWORK_CONNECTION_UPDATES_:
            ...
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT_:
                return stateVector[5].ordinal() >= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT_.ordinal() && stateVector[5].ordinal() <= State._SMARTFIRESYSTEM__SMARTFIRESYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT___RECEIVING_UPDATES_FROM_POWER_COMPONENT___POWER_CONSUMPTION_UPDATES_.ordinal();
            case _SMARTFIRESYSTEM__SMARTFIRESYSTEM_POWERCALCULATORCOMPONENT__INITIALIZE_POWER_COMPONENT___RECEIVING_UPDATES_FROM_POWER_COMPONENT___POWER_CONSUMPTION_UPDATES_:
    ...
    private Actuator_Component getActuator() {
        return actuator;
    }
    ...
    private Controller_Component getController() {
        return controller;
    }
    ...
    private Sensor_Component getCarbonSensor() {
        return carbonSensor;
    }
    ...
    private Sensor_Component getSmokeSensor() {
        return smokeSensor;
    }
    ...
    private Sensor_Component getHeatSensor() {
        return heatSensor;
    }
    ...
    private Power_Component getPower() {
        return power;
    }
    ...
    private DeviceTemp_Component getTemp() {
        return temp;
    }
    ...
    private FireAlarm_Unit getFireAlarm() {
        return fireAlarm;
    }
    ...
    private boolean getWiFi_connection() {
        return wiFi_connection;
    }

    private void setWiFi_connection(boolean value) {
        this.wiFi_connection = value;
    }

    private long temp_value;

    private long getTemp_value() {
        return temp_value;
    }

    private void setTemp_value(long value) {
        this.temp_value = value;
    }

    private long power_input;

    private long getPower_input() {
        return power_input;
    }

    private void setPower_input(long value) {
        this.power_input = value;
    }

    private long power_total;

    private long getPower_total() {
        return power_total;
    }

    private void setPower_total(long value) {
        this.power_total = value;
    }

    private long power_required;

    private long getPower_required() {
        return power_required;
    }

    private void setPower_required(long value) {
