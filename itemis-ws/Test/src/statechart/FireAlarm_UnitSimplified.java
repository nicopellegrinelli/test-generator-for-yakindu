...
public class FireAlarm_UnitSimplified implements ITimed, IEventDriven {

    public static class Timer {

        private FireAlarm_UnitSimplified parent;

        public Timer(FireAlarm_UnitSimplified parent) {
            this.parent = parent;
        }
        ...
        private long getWarning_period() {
            return warning_period;
        }

        private void setWarning_period(long value) {
            this.warning_period = value;
        }

        private long final_warning_period;

        private long getFinal_warning_period() {
            return final_warning_period;
        }

        private void setFinal_warning_period(long value) {
    ...
    public static class Message {
        ...
        private void setSensor(String value) {
            this.sensor = value;
        }
    }
    ...
    public static class Mode {
        ...
        public Mode(FireAlarm_UnitSimplified parent) {
            this.parent = parent;
        }
    ...
    public static class Alarm {
        ...
        public Alarm(FireAlarm_UnitSimplified parent) {
            this.parent = parent;
        }
        ...
        private boolean getThreshold_reached() {
            return threshold_reached;
        }

        private void setThreshold_reached(boolean value) {
    ...
    public static class Sensors {
        ...
        private boolean getTriggerSignal_received() {
            return triggerSignal_received;
        }

        private void setTriggerSignal_received(boolean value) {
            this.triggerSignal_received = value;
        }

        private boolean smoke_presence;

        private boolean getSmoke_presence() {
            return smoke_presence;
        }

        private void setSmoke_presence(boolean value) {
            this.smoke_presence = value;
        }

        private boolean carbon_presence;

        private boolean getCarbon_presence() {
            return carbon_presence;
        }

        private void setCarbon_presence(boolean value) {
            this.carbon_presence = value;
        }

        private boolean heat_presence;

        private boolean getHeat_presence() {
            return heat_presence;
        }

        private void setHeat_presence(boolean value) {
            this.heat_presence = value;
        }

        private long smoke_value;

        private long getSmoke_value() {
            return smoke_value;
        }

        private void setSmoke_value(long value) {
            this.smoke_value = value;
        }

        private long carbon_value;

        private long getCarbon_value() {
            return carbon_value;
        }

        private void setCarbon_value(long value) {
            this.carbon_value = value;
        }

        private long heat_value;

        private long getHeat_value() {
            return heat_value;
        }

        private void setHeat_value(long value) {
            this.heat_value = value;
        }

        private long smoke_increment;

        private long getSmoke_increment() {
            return smoke_increment;
        }

        private void setSmoke_increment(long value) {
            this.smoke_increment = value;
        }

        private long carbon_increment;

        private long getCarbon_increment() {
            return carbon_increment;
        }

        private void setCarbon_increment(long value) {
            this.carbon_increment = value;
        }

        private long heat_increment;

        private long getHeat_increment() {
            return heat_increment;
        }

        private void setHeat_increment(long value) {
            this.heat_increment = value;
        }

        private long smoke_warning;

        private long getSmoke_warning() {
            return smoke_warning;
        }

        private void setSmoke_warning(long value) {
            this.smoke_warning = value;
        }

        private long smoke_threshold;

        private long getSmoke_threshold() {
            return smoke_threshold;
        }

        private void setSmoke_threshold(long value) {
            this.smoke_threshold = value;
        }

        private long carbon_warning;

        private long getCarbon_warning() {
            return carbon_warning;
        }

        private void setCarbon_warning(long value) {
            this.carbon_warning = value;
        }

        private long carbon_threshold;

        private long getCarbon_threshold() {
            return carbon_threshold;
        }

        private void setCarbon_threshold(long value) {
            this.carbon_threshold = value;
        }

        private long hear_warning;

        private long getHear_warning() {
            return hear_warning;
        }

        private void setHear_warning(long value) {
            this.hear_warning = value;
        }

        private long heat_threshold;

        private long getHeat_threshold() {
            return heat_threshold;
        }

        private void setHeat_threshold(long value) {
    ...
    public FireAlarm_UnitSimplified() {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING_:
                return stateVector[0].ordinal() >= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING_.ordinal() && stateVector[0].ordinal() <= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__FINAL_WARNING_ENDED.ordinal();
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__ALARM_SWITCH_ALARM_OFF:
            ...
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__STATUS_WARNING:
                return stateVector[1].ordinal() >= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__STATUS_WARNING.ordinal() && stateVector[1].ordinal() <= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__STATUS_WARNING_LEVEL_FINAL_WARNING.ordinal();
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__STATUS_WARNING_LEVEL_INITIAL_WARNING:
            ...
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__STATUS_DANGER:
                return stateVector[1].ordinal() >= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__STATUS_DANGER.ordinal() && stateVector[1].ordinal() <= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__STATUS_DANGER__911_ACTIVATED___911_EMERGENCY_ACTIVATED.ordinal();
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__STATUS_DANGER__911_ACTIVATED___911_EMERGENCY_ACTIVATED:
            ...
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_TRIGGERED_:
                return stateVector[2].ordinal() >= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_TRIGGERED_.ordinal() && stateVector[2].ordinal() <= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_TRIGGERED__HEATSENSOR__MONITORING_HEAT_LEVEL_.ordinal();
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__SENSOR_TRIGGERED__SMOKESENSOR__MONITORING_SMOKE_LEVEL_:
            ...
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__THRESHOLD_REACHED_:
                return stateVector[2].ordinal() >= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__THRESHOLD_REACHED_.ordinal() && stateVector[2].ordinal() <= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__THRESHOLD_REACHED__WARNING_BEFORE_SOUNDING_SOUNDALARM.ordinal();
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__MONITORING_SENSOR_LEVEL__THRESHOLD_REACHED__WARNING_BEFORE_SOUNDING_SENSORWARNING:
            ...
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING_:
                return stateVector[5].ordinal() >= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING_.ordinal() && stateVector[5].ordinal() <= State._FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__FINAL_WARNING_ENDED.ordinal();
            case _FIREALARM_UNIT___FIRE_ALARM_RUNNING__TIMER_STATUS__TIMER_RUNNING__R1__FINAL_WARNING_:
    ...
    private boolean getWarned() {
        return warned;
    }

    private void setWarned(boolean value) {
        this.warned = value;
    }
