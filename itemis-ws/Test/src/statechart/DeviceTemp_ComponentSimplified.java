...
public class DeviceTemp_ComponentSimplified implements ITimed, IEventDriven {
    ...
    public static class Device {
        ...
        private boolean getCooling_down() {
            return cooling_down;
        }

        private void setCooling_down(boolean value) {
            this.cooling_down = value;
        }

        private boolean heating_up;

        private boolean getHeating_up() {
            return heating_up;
        }

        private void setHeating_up(boolean value) {
    ...
    public static class Heat {
        ...
        private DeviceTemp_ComponentSimplified parent;

        public Heat(DeviceTemp_ComponentSimplified parent) {
            this.parent = parent;
        }
        ...
        private void setIncrement(long value) {
            this.increment = value;
        }

        private long decrement;

        private long getDecrement() {
            return decrement;
        }

        private void setDecrement(long value) {
        ...
        private boolean getUser_warned() {
            return user_warned;
        }

        private void setUser_warned(boolean value) {
    ...
    public DeviceTemp_ComponentSimplified() {
        device = new Device();
        heat = new Heat(this);
        for (int i = 0; i < 1; i++) {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            case _DEVICETEMP_COMPONENT___TEMPERATURE_COMPONENT_:
                return stateVector[0].ordinal() >= State._DEVICETEMP_COMPONENT___TEMPERATURE_COMPONENT_.ordinal() && stateVector[0].ordinal() <= State._DEVICETEMP_COMPONENT___TEMPERATURE_COMPONENT___MONITORING_DEVICE_TEMPERATURE__COOLINGSTATE__DEVICE_COOLING_DOWN__FULLY_RESTED.ordinal();
            case _DEVICETEMP_COMPONENT___TEMPERATURE_COMPONENT___MONITORING_DEVICE_TEMPERATURE__RESTSTATE:
            ...
            case _DEVICETEMP_COMPONENT___TEMPERATURE_COMPONENT___MONITORING_DEVICE_TEMPERATURE__COOLINGSTATE:
                return stateVector[0].ordinal() >= State._DEVICETEMP_COMPONENT___TEMPERATURE_COMPONENT___MONITORING_DEVICE_TEMPERATURE__COOLINGSTATE.ordinal() && stateVector[0].ordinal() <= State._DEVICETEMP_COMPONENT___TEMPERATURE_COMPONENT___MONITORING_DEVICE_TEMPERATURE__COOLINGSTATE__DEVICE_COOLING_DOWN__FULLY_RESTED.ordinal();
            case _DEVICETEMP_COMPONENT___TEMPERATURE_COMPONENT___MONITORING_DEVICE_TEMPERATURE__COOLINGSTATE__DEVICE_COOLING_DOWN__COOLING:
    ...
    private boolean getFully_rested() {
        return fully_rested;
    }

    private void setFully_rested(boolean value) {
