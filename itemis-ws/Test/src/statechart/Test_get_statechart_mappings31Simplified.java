...
public class Test_get_statechart_mappings31Simplified implements IEventDriven {

    public enum State {

        MAIN_REGION_STATEA, MAIN_REGION_STATEB, MAIN_REGION_STATEC, $NULLSTATE$
    }
    ...
    public Test_get_statechart_mappings31Simplified() {
        for (int i = 0; i < 1; i++) {
    ...
    public void enter() {
        ...
        isExecuting = true;
        /* Default enter sequence for statechart test_get_statechart_mappings31 */
    ...
    public void exit() {
        ...
        isExecuting = true;
        /* Default exit sequence for statechart test_get_statechart_mappings31 */
