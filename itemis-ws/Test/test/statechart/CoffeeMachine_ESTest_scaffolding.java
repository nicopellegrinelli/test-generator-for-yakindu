...
public class CoffeeMachine_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart.CoffeeMachine"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CoffeeMachine_ESTest_scaffolding.class.getClassLoader() ,
      "com.yakindu.core.IStatemachine",
      "statechart.CoffeeMachine$State",
      "com.yakindu.core.ITimerService",
      "statechart.CoffeeMachine$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CoffeeMachine_ESTest_scaffolding.class.getClassLoader()); 
