...
public class Lampada_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart.Lampada"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Lampada_ESTest_scaffolding.class.getClassLoader() ,
      "com.yakindu.core.IStatemachine",
      "com.yakindu.core.rx.Observer",
      "statechart.Lampada",
      "statechart.Lampada$1",
      "statechart.Lampada$State",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Lampada_ESTest_scaffolding.class.getClassLoader()); 
