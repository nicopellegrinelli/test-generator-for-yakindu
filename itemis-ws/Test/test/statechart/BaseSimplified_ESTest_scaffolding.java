...
public class BaseSimplified_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart.BaseSimplified"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BaseSimplified_ESTest_scaffolding.class.getClassLoader() ,
      "com.yakindu.core.IStatemachine",
      "statechart.BaseSimplified$State",
      "statechart.BaseSimplified$1",
      "com.yakindu.core.rx.Observer",
      "statechart.BaseSimplified",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.yakindu.core.ITimerService", false, BaseSimplified_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BaseSimplified_ESTest_scaffolding.class.getClassLoader()); 
