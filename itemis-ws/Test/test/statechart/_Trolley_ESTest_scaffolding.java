...
public class _Trolley_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart._Trolley"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(_Trolley_ESTest_scaffolding.class.getClassLoader() ,
      "statechart._Trolley",
      "com.yakindu.core.IStatemachine",
      "com.yakindu.core.rx.Observer",
      "statechart._Trolley$State",
      "com.yakindu.core.ITimerService",
      "com.yakindu.core.IEventDriven",
      "com.yakindu.core.rx.Observable",
      "statechart._Trolley$1",
      "com.yakindu.core.ITimed"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(_Trolley_ESTest_scaffolding.class.getClassLoader()); 
