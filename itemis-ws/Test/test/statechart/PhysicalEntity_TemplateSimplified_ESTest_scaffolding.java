...
public class PhysicalEntity_TemplateSimplified_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart.PhysicalEntity_TemplateSimplified"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PhysicalEntity_TemplateSimplified_ESTest_scaffolding.class.getClassLoader() ,
      "com.yakindu.core.IStatemachine",
      "statechart.PhysicalEntity_TemplateSimplified$State",
      "statechart.Power_Component",
      "statechart.PhysicalEntity_TemplateSimplified$Oscillator",
      ...
      "statechart.PhysicalEntity_TemplateSimplified$Trigger",
      "com.yakindu.core.ITimed",
      "statechart.PhysicalEntity_TemplateSimplified$Frequency",
      "statechart.Actuator_Component$Device",
      "statechart.Controller_Component$State",
      "statechart.PhysicalEntity_TemplateSimplified$Status",
      "statechart.Actuator_Component$1",
      "statechart.Power_Component$Device",
      "statechart.Actuator_Component",
      "statechart.PhysicalEntity_TemplateSimplified$Power",
      "statechart.Power_Component$1",
      "statechart.Controller_Component$1",
      "statechart.PhysicalEntity_TemplateSimplified$Comparator",
      "statechart.Actuator_Component$Power",
      "statechart.Power_Component$State",
      "statechart.PhysicalEntity_TemplateSimplified",
      "statechart.Controller_Component$Actuator",
      "com.yakindu.core.ITimerService",
      "statechart.PhysicalEntity_TemplateSimplified$1"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PhysicalEntity_TemplateSimplified_ESTest_scaffolding.class.getClassLoader()); 
