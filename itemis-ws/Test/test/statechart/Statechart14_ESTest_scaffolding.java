...
public class Statechart14_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart.Statechart14"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Statechart14_ESTest_scaffolding.class.getClassLoader() ,
      "com.yakindu.core.IStatemachine",
      "com.yakindu.core.rx.Observer",
      "statechart.Statechart14$State",
      "statechart.Statechart14",
      "com.yakindu.core.ITimerService",
      "statechart.Statechart14$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Statechart14_ESTest_scaffolding.class.getClassLoader()); 
