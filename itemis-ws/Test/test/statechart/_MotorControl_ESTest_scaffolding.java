...
public class _MotorControl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart._MotorControl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(_MotorControl_ESTest_scaffolding.class.getClassLoader() ,
      "com.yakindu.core.IStatemachine",
      "statechart._MotorControl$State",
      "statechart._MotorControl",
      "com.yakindu.core.rx.Observer",
      "statechart._MotorControl$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(_MotorControl_ESTest_scaffolding.class.getClassLoader()); 
