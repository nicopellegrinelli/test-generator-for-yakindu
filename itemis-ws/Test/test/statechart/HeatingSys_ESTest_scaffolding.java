...
public class HeatingSys_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart.HeatingSys"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HeatingSys_ESTest_scaffolding.class.getClassLoader() ,
      "com.yakindu.core.IStatemachine",
      "statechart.HeatingSys",
      "statechart.HeatingSys$State",
      "com.yakindu.core.ITimerService",
      "statechart.HeatingSys$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HeatingSys_ESTest_scaffolding.class.getClassLoader()); 
