...
public class _Physics_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart._Physics"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(_Physics_ESTest_scaffolding.class.getClassLoader() ,
      "com.yakindu.core.IStatemachine",
      "statechart._Physics$1",
      "com.yakindu.core.rx.Observer",
      "statechart._Physics",
      "statechart._Physics$State",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(_Physics_ESTest_scaffolding.class.getClassLoader()); 
