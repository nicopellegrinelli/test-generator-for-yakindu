...
public class BareMetalPolling_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "statechart.BareMetalPolling"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BareMetalPolling_ESTest_scaffolding.class.getClassLoader() ,
      "statechart.BareMetalPolling$1",
      "com.yakindu.core.IStatemachine",
      "com.yakindu.core.rx.Observer",
      "statechart.BareMetalPolling",
      "com.yakindu.core.ITimerService",
      "statechart.BareMetalPolling$State",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BareMetalPolling_ESTest_scaffolding.class.getClassLoader()); 
