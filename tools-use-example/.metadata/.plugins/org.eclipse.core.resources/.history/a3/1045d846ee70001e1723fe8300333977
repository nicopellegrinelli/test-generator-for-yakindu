...
public class CallHandlingMachine_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "callhandling.CallHandlingMachine"; 
  ...
  public static void setSystemProperties() {
    ...
    java.lang.System.setProperty("user.dir", "C:\\Users\\lenovo\\Desktop\\ProgettiGit\\test-generator-for-yakindu\\tools-use-example\\CallHandlingProject\\test"); 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CallHandlingMachine_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "callhandling.CallHandlingMachine$User",
      "com.yakindu.core.VirtualTimer$CycleTimeEventTask",
      "callhandling.CallHandlingMachine$State",
      "com.yakindu.core.IEventDriven",
      "com.yakindu.core.ITimed",
      "com.yakindu.core.TimerService$TimeEventTask",
      "callhandling.CallHandlingMachine",
      "com.yakindu.core.TimerService",
      "callhandling.CallHandlingMachine$Phone",
      "com.yakindu.core.ITimerService"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CallHandlingMachine_ESTest_scaffolding.class.getClassLoader()); 
