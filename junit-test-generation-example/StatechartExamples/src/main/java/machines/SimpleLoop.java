...
public class SimpleLoop implements IStatemachine, IEventDriven {
	public static class Light {
		private SimpleLoop parent;
		
		public Light(SimpleLoop parent) {
			this.parent = parent;
		}
	...
	public void enter() {
		...
		isExecuting = true;
		/* Default enter sequence for statechart SimpleLoop */
	...
	public void exit() {
		...
		isExecuting = true;
		/* Default exit sequence for statechart SimpleLoop */
