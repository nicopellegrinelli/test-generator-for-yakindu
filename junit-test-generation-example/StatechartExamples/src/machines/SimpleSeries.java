...
public class SimpleSeries implements IStatemachine, IEventDriven {
	public enum State {
		MAIN_REGION_STATEA,
		MAIN_REGION_STATEB,
		MAIN_REGION_STATEC,
	...
	public void enter() {
		...
		isExecuting = true;
		/* Default enter sequence for statechart SimpleSeries */
	...
	public void exit() {
		...
		isExecuting = true;
		/* Default exit sequence for statechart SimpleSeries */
