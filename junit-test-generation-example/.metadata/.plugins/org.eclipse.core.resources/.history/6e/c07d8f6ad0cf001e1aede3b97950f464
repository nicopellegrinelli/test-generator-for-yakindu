...
import com.temp.impl.ExamplStc;
...
public class ExamplStc_ESTest extends ExamplStc_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      ExamplStc examplStc0 = new ExamplStc();
      examplStc0.setStateConfVectorPosition((-915L));
      long long0 = examplStc0.getStateConfVectorPosition();
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: NullPointerException");
         ...
         //
         verifyException("com.temp.impl.ExamplStc", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ExamplStc examplStc0 = new ExamplStc();
      examplStc0.enter();
      examplStc0.raiseUsed1();
      examplStc0.raiseUsed2();
      assertTrue(examplStc0.isActive());
  }
  ...
  public void test17()  throws Throwable  {
      ...
      examplStc0.enter();
      examplStc0.raiseUsed1();
      ExamplStc.State examplStc_State0 = ExamplStc.State.OUT_REGION_OUT2;
      boolean boolean0 = examplStc0.isStateActive(examplStc_State0);
      assertTrue(examplStc0.isActive());
      assertTrue(boolean0);
  }
  ...
  public void test18()  throws Throwable  {
      ExamplStc examplStc0 = new ExamplStc();
      examplStc0.enter();
      ExamplStc.State examplStc_State0 = ExamplStc.State.OUT_REGION_OUT1;
      boolean boolean0 = examplStc0.isStateActive(examplStc_State0);
      assertTrue(examplStc0.isActive());
      assertTrue(boolean0);
  }
