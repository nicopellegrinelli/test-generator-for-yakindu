...
public class EntryExitSimplified implements IEventDriven {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            ...
            case MAIN_REGION_MULTIPLE_ALTERNATIVES:
                return stateVector[0].ordinal() >= State.MAIN_REGION_MULTIPLE_ALTERNATIVES.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_MULTIPLE_ALTERNATIVES_R1_C.ordinal();
            case MAIN_REGION_MULTIPLE_ALTERNATIVES_R1_A:
