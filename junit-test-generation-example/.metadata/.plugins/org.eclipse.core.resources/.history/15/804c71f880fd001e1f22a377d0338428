...
public class EventsSimplified implements ICycleBased {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            ...
            case MAIN_REGION_STATEZ:
                return stateVector[0].ordinal() >= State.MAIN_REGION_STATEZ.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_STATEZ_R2_STATEF.ordinal();
            case MAIN_REGION_STATEZ_R1_STATEC:
    ...
    private void raiseInternalEvent() {
        internalEvent = true;
    }

    private void raiseLocal_typedOutEvent(long value) {
        local_typedOutEventValue = value;
        local_typedOutEvent = true;
    }

    private long getLocal_typedOutEventValue() {
    ...
    private Observable<Void> getOutEvent() {
    ...
    private double getTypedInEventValue() {
        if (!typedInEvent)
    ...
    private void raiseTypedOutEvent(long value) {
    ...
    private Observable<Long> getTypedOutEvent() {
