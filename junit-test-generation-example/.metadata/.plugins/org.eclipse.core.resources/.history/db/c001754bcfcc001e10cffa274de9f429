...
public class StatechartSimplified implements IEventDriven {
    ...
    public boolean isStateActive(State state) {
        switch(state) {
            ...
            case MAIN_REGION_ON_R_0_ANALYSES012:
                return stateVector[0].ordinal() >= State.MAIN_REGION_ON_R_0_ANALYSES012.ordinal() && stateVector[0].ordinal() <= State.MAIN_REGION_ON_R_0_ANALYSES012_R_2_AN2_B.ordinal();
            case MAIN_REGION_ON_R_0_ANALYSES012_R___1_AN1:
