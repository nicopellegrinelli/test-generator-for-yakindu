...
public class LightSimplified implements ICycleBased {
    ...
    static final private double y = 3.14;
    ...
    static final private long maxBrightness = 100l;

    private long getMaxBrightness() {
        return maxBrightness;
    }

    static final private long minBrightness = 30l;

    private long getMinBrightness() {
